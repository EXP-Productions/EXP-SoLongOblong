...
public class objReaderCSharpV4 : MonoBehaviour {
	...
	public Material m_DefaultMatieral;
	...
	{
		yield return StartCoroutine(SomeFunction(name));
	}
	...
	public IEnumerator SomeFunction(string name) 
	{
		GameObject obj_gameobject = GameObject.Find(name);
		...
		WWW www3d = new WWW( "file:///" + _textFieldString);
		print( "Loading from: " + "file:///" + _textFieldString );
		yield return www3d;
		if (www3d.data == null)
		...
		/*
		TextAsset loadedOBJ = Resources.Load ("TestOBJ") as string;
		if (loadedOBJ.text == null)
			return;

		string s = loadedOBJ.text*/
		...
		temp2.material = m_DefaultMatieral;
		/*
